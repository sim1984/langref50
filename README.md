Language Reference for Firebird 5.0 Beta 1
=========================================

Это руководство описывает язык SQL, поддерживаемый СУБД Firebird 5.0.

***
Внимание! В настоящий момент Firebird 5.0 активно разрабатывается. 
Многие функции ещё не завершены окончательно, их описание может быть изменено.
***
